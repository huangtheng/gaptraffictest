(function () {
    "use strict";
    angular.module("TrafficLaws.TestController", ['ui.router', 'TrafficLaws.databaseService'])
    .controller('TestCtrl', function ($scope, $rootScope, $q, $sce, $state, $window, db, $interval, $timeout, $http, $ionicModal, $ionicLoading) {
        ...
        function startTimer(duration) {
            ...
            interval = $interval(function () {
                ...
                $rootScope.titleAll =  minutes + ":" + seconds + " ";
