(function () {
    "use strict";
    angular.module("TrafficLaws", ['ionic', 'ngMaterial', 'ui.router', 'ngMessages', "chart.js", 'ngAnimate', 'TrafficLaws.cordovaService', 'TrafficLaws.databaseService', 'TrafficLaws.HomeController', "TrafficLaws.SearchController", "TrafficLaws.CategoriesController", 'TrafficLaws.QuestionController', 'TrafficLaws.SettingController', 'TrafficLaws.QuestionSearchController', 'TrafficLaws.connectService', "TrafficLaws.TestController", "TrafficLaws.StatisticController", "TrafficLaws.Statistic2Controller", "TrafficLaws.ThemeController"])
    ...
    .controller('MasterCtrl', function ($scope, $rootScope, $ionicPopup, $window, $q, $state, $sce, cordova, db, $timeout, $http, $ionicLoading, $mdSidenav, connect) {
        ...
        function onBack() {
            if (!$rootScope.isSetting && !$rootScope.isBack) {
                ...
                if ($rootScope.startApp != 1 && !$rootScope.questionTheme && !$rootScope.isClear) {
                    ...
                    {
                        console.log("none questionTheme back");
                        $window.history.back();
                    }
                    if (!$rootScope.question && !$rootScope.isClear && !$rootScope.statistic2) {
                        ...
                        console.log("questionTheme back");
                        $window.history.back();
                        $rootScope.questionTheme = false;
                    }
