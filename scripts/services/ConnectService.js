(function () {
    "use strict";
    angular.module('TrafficLaws.connectService', ['ui.router', 'ngAnimate', 'TrafficLaws.databaseService'])
                ...
                getAllQuestion: function () {
                    ...
                    if ($rootScope.language == 0) {
                        var menuQuestion = [
                            ...
                            { name: $rootScope.Menu.vn.number_question, event: 7, number: "", percent: "", icon: 'fa-file-excel-o' },
                            { name: $rootScope.Menu.vn.variant_question, event: 8, number: "", percent: "", icon: 'fa-file-image-o' },
                            { name: $rootScope.Menu.vn.film_question, event: 9, number: "", percent: "", icon: 'fa-file-video-o' }
                        ];
                    }
                    else
                    {
                        var menuQuestion = [
                            ...
                            { name: $rootScope.Menu.de.number_question, event: 7, number: "", percent: "", icon: 'fa-file-excel-o' },
                            { name: $rootScope.Menu.de.variant_question, event: 8, number: "", percent: "", icon: 'fa-file-image-o'  },
                            { name: $rootScope.Menu.de.film_question, event: 9, number: "", percent: "", icon: 'fa-file-video-o' }
                        ];
                    }
