                                        ...
                                        if (itemData.ZISINPUT) {
                                            ...
                                            if (true) {
                                                ...
                                                if (t2 > 0) {
                                                    ...
                                                    itemData.ANSWERINPUTSTRING1VN = "<p>" + utils.convertText(answer1) + "</p>" + "&nbsp<input class='ipAnswer1' type='number' value='' />" + '&nbsp<p> ' + utils.convertText(text1) + '</p>' + "&nbsp<input class='ipAnswer2' value='' type='number' />" + '&nbsp<p>' + utils.convertText(text2) + '</p>';
                                                    ...
                                                    itemData.ANSWERINPUTSTRING1VN = "<p>" + utils.convertText(answer1) + " </p>&nbsp" + "<input class='ipAnswer' value='' type='number' />" + '&nbsp<p> ' + utils.convertText(text) + '</p>';
                                            ...
                                            if (t2 > 0) {
                                                ...
                                                itemData.ANSWERINPUTSTRING1 = "<p>" + utils.convertText(answer1) + "</p>" + "&nbsp<input class='ipAnswer1' type='number' value='' />" + '&nbsp<p> ' + utils.convertText(text1) + '</p>' + "&nbsp<input class='ipAnswer2' value='' type='number' />" + '&nbsp<p>' + utils.convertText(text2) + '</p>';
                                                ...
                                                itemData.ANSWERINPUTSTRING1 = "<p>" + utils.convertText(answer1) + " </p>&nbsp" + "<input class='ipAnswer' value='' type='number' />" + '&nbsp<p> ' + utils.convertText(text) + '</p>';
